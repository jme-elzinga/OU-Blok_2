...
class VectorTest {
  ...
  @Test
  void testEquals() {
    assertEquals(true,testVector1.equals(testVector1));
    assertEquals(false,testVector1.equals(testVector2));
    assertEquals(false,testVector1.equals(testVector3));
    assertEquals(false,testVector1.equals(testVector4));
    assertEquals(false,testVector1.equals(testVector5));
    assertEquals(false,testVector1.equals(testVector10));
    assertEquals(false,testVector1.equals(testVector11));
    assertEquals(true,testVector2.equals(testVector2));
    assertEquals(false,testVector2.equals(testVector3));
    assertEquals(false,testVector2.equals(testVector4));
    assertEquals(false,testVector2.equals(testVector5));
    assertEquals(false,testVector2.equals(testVector10));
    assertEquals(false,testVector2.equals(testVector11));
    assertEquals(true,testVector3.equals(testVector3));
    assertEquals(false,testVector3.equals(testVector4));
    assertEquals(false,testVector3.equals(testVector5));
    assertEquals(false,testVector3.equals(testVector10));
    assertEquals(false,testVector3.equals(testVector11));
    assertEquals(true,testVector4.equals(testVector4));
    assertEquals(false,testVector4.equals(testVector5));
    assertEquals(false,testVector4.equals(testVector10));
    assertEquals(false,testVector4.equals(testVector11));
    assertEquals(true,testVector5.equals(testVector5));
    assertEquals(true,testVector10.equals(testVector10));
    assertEquals(false,testVector10.equals(testVector11));
    assertEquals(true,testVector11.equals(testVector11));
  }
  ...
  void testHeeftZelfdeRichting() {
    assertEquals(true,testVector1.heeftZelfdeRichting(testVector1));
    assertEquals(true,testVector1.heeftZelfdeRichting(testVector6));
    assertEquals(false,testVector1.heeftZelfdeRichting(testVector2));
    assertEquals(false,testVector1.heeftZelfdeRichting(testVector3));
    assertEquals(false,testVector1.heeftZelfdeRichting(testVector4));
    assertEquals(true,testVector1.heeftZelfdeRichting(testVector5));
    assertEquals(true,testVector2.heeftZelfdeRichting(testVector2));
    assertEquals(true,testVector2.heeftZelfdeRichting(testVector7));
    assertEquals(false,testVector2.heeftZelfdeRichting(testVector3));
    assertEquals(false,testVector2.heeftZelfdeRichting(testVector4));
    assertEquals(true,testVector2.heeftZelfdeRichting(testVector5));
    assertEquals(true,testVector3.heeftZelfdeRichting(testVector3));
    assertEquals(true,testVector3.heeftZelfdeRichting(testVector8));
    assertEquals(false,testVector3.heeftZelfdeRichting(testVector4));
    assertEquals(true,testVector3.heeftZelfdeRichting(testVector5));
    assertEquals(true,testVector4.heeftZelfdeRichting(testVector4));
    assertEquals(true,testVector4.heeftZelfdeRichting(testVector9));
    assertEquals(true,testVector4.heeftZelfdeRichting(testVector5));
    assertEquals(true,testVector5.heeftZelfdeRichting(testVector5));
    assertEquals(true,testVector10.heeftZelfdeRichting(testVector10));
    assertEquals(true,testVector11.heeftZelfdeRichting(testVector11));
  }
