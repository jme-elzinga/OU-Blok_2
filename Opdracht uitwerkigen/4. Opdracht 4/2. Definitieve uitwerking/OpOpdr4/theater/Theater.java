...
public class Theater {
   ...
   * @return klantobject van de nieuwe klant.
   */
  private Klant maakKlant(String naam, String telefoon) {
    Klant klant = new Klant(nieuwKlantnummer(),naam, telefoon);
    klanten.add(klant);
    return klant;
  }
